...
This is a sample template for sam201905 - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sam201905 --query 'Stacks[].Outputs'
```
